                ...
                <div className="space-y-4">
                  <SignUpButton mode="modal">
                    <button
                      ...
                      className="group relative w-full py-4 px-6 bg-gradient-to-r from-violet-600 to-indigo-600 text-white rounded-xl font-semibold text-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-violet-500/50 hover:scale-105"
                    >
                  ...
                  <SignInButton mode="modal">
                    <button className="w-full py-4 px-6 bg-white/10 backdrop-blur-sm border-2 border-white/30 text-white rounded-xl font-semibold text-lg hover:bg-white/20 hover:border-white/50 transition-all duration-300 hover:scale-105">
            ...
            <div className="mt-8 overflow-hidden">
              <div className="flex space-x-4 animate-scroll">
                {[...testimonials, ...testimonials].map((testimonial, idx) => (
                  <div
                    key={idx}
                    className="flex-shrink-0 w-64 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-4"
                  >
